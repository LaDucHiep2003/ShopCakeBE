...
class OrderModel extends BaseModel
{
    ...
    public function momoPayment($data)
    {
        ...
        $orderId = time() . "";
        $requestId = time() . "";
        $redirectUrl = $data['redirectUrl'] ?? "http://localhost:8080/checkout";
        $ipnUrl = $data['ipnUrl'] ?? "http://localhost:8080/checkout";
        ...
        $result = $this->execPostRequest($endpoint, json_encode($dataPayment));
